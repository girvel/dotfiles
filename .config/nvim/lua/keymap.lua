...
keymap.init = function()
  ...
  Api.rumap("n", "<leader>le", ":LspStart<CR>", {desc = "LSP: Start (enable)"})
  Api.rumap("n", "<leader>ld", ":LspStop<CR>", {desc = "LSP: Stop (disable)"})
  Api.rumap("n", "<leader>ls", ":LspRestart<CR>", {desc = "LSP: Restart LSP"})
